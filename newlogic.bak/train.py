...
if __name__ == "__main__":
    ...
    # ts.build_and_train(vgg_name='VGG11', n_epochs=10, use_maxout='max', use_relog=True, use_quadratic_kernel=True)
    ts.build_and_train('cnn-cifar10-relog-kernel', use_quadratic_kernel=True,
